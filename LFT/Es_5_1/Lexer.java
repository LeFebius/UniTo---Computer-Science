...
public class Lexer {
                ...
                if (Character.isLetter(peek) || peek == '_' ) {
                  ...
                  return null;}
                    ...
                    do {
                        ...
                        readch(br);
                        if (peek == '_') {
                            System.err.println("Warning, numbers cannot contain underscore symbols" );
                            return null;
                        }
    ...
    public static void main(String[] args) {
        Lexer lex = new Lexer();
        String path = "InputTest.txt"; // percorso del file da leggere
        try {
